...
export const addPhotoButton = container.querySelector(".profile__add-btn");
export const changeAvatarButton = container.querySelector(".profile__change-btn");
export const popupProfile = document.querySelector('.popup_type_edit');
export const popupProfileInputs = popupProfile.querySelectorAll('.popup__input');
